...
class Example(object):
    ...
    def __init__(self, article, abstract_sentences, aspect, vocab):
...
class Batch(object):
    def __init__(self, example_list, vocab, batch_size):
        ...
        :param example_list: A list of various articles, abstract, aspects with length of this list == batch_size
        :param vocab:
        :param batch_size:
        """
    ...
    def store_orig_strings(self, example_list):
        ...
        self.final_aspects = [ex.original_aspect for ex in example_list]
...
class Batcher(object):
    ...
    :param data_path:
    :param vocab: the vocabulary, based on Vocab class
    :param mode: train, dev or test
    :param batch_size: The batch_size we intend to have
    :param single_pass: If True, run through the dataset exactly once (useful for when you want to run evaluation on the dev or test set). Otherwise generate random batches indefinitely (useful for training).
    """
    ...
    def fill_example_queue(self):
        ...
        while True:
            try:
                (article,
                 abstract, aspect) = next(input_gen)  # read the next example from file. article and abstract are both strings.
            ...
            example = Example(article, abstract_sentences, aspect, self._vocab)  # Process into an Example.
            self._example_queue.put(example)  # place the Example in the example queue.

    def fill_batch_queue(self):
        """
        batch queue uses input queue to fill itself
        :return:
        """
        while True:
            if self.mode == 'decode':
    ...
    def text_generator(self, example_generator):
        while True:
            ...
            try:
                ...
                aspect = e.features.feature['aspect'].bytes_list.value[0]
            except ValueError:
            ...
            if len(article_text) == 0:  # See https://github.com/abisee/pointer-generator/issues/1
                ...
                yield (article_text, abstract_text, aspect)
