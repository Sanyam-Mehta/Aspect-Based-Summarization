...
def get_input_from_batch(batch, use_cuda):
    ...
    return enc_batch, enc_padding_mask, enc_lens, enc_batch_extend_vocab, extra_zeros, c_t_1, coverage, aspects
...
def get_output_from_batch(batch, use_cuda):
    ...
    return dec_batch, dec_padding_mask, max_dec_len, dec_lens_var, target_batch, aspects
